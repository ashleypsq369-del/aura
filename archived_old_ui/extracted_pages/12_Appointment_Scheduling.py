"""
Appointment Scheduling - Project Aura
...
username, role = setup_page("Appointment Scheduling", "📅")

# Render page header
render_page_header("Appointment Scheduling", "📅", "Manage appointments and care team calendar")
