...
def render():
    ...
    <div style='background: linear-gradient(135deg, #4299E1 0%, #2C5282 100%); color: white; padding: 2rem; border-radius: 20px; margin-bottom: 2rem;'>
        ...
        <h1 style='color: white; text-align: center; margin: 0;'>Caregiver Portal</h1>
        <p style='text-align: center; font-size: 1.1rem; margin-top: 1rem; opacity: 0.9;'>Caregiver resources and tools</p>
    </div>
